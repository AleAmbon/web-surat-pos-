...
if (isset($_POST['submit'])) {
    ...
    if (isset($_FILES['file_surat']) && $_FILES['file_surat']['error'] == 0) {
        ...
        $file_name = "OUT_" . time() . "_" . uniqid() . "." . $file_ext;
    ...
    if (isset($_POST['id']) && !empty($_POST['id'])) {
        ...
        $query = "UPDATE surat_keluar SET no_surat='$no_surat', tgl_surat='$tgl_surat', tgl_kirim='$tgl_kirim', tujuan_surat='$tujuan_surat', perihal='$perihal' $update_file WHERE id=$id";
    } else {
        $query = "INSERT INTO surat_keluar (no_surat, tgl_surat, tgl_kirim, tujuan_surat, perihal, file_surat) VALUES ('$no_surat', '$tgl_surat', '$tgl_kirim', '$tujuan_surat', '$perihal', '$file_name')";
    }
...
if (isset($_GET['delete'])) {
    ...
    $res = mysqli_query($koneksi, "SELECT file_surat FROM surat_keluar WHERE id=$id");
...
// Fetch Data
$query = "SELECT * FROM surat_keluar $where ORDER BY created_at DESC";
...
if (isset($_GET['edit'])) {
    $id = $_GET['edit'];
    $edit_res = mysqli_query($koneksi, "SELECT * FROM surat_keluar WHERE id=$id");
...
<head>
    ...
    <title>Surat Keluar - Surat App</title>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Outfit', sans-serif; }
        ...
        .nav-link.active { background: rgba(168, 85, 247, 0.1); color: #a855f7; border-color: rgba(168, 85, 247, 0.2); }
        ...
        .btn-primary:hover { opacity: 0.9; transform: translateY(-2px); box-shadow: 0 4px 12px rgba(168, 85, 247, 0.3); }
...
<body>
    <div class="sidebar" id="sidebar">
        ...
        <ul class="nav-menu">
            ...
            <li class="nav-item"><a href="surat_keluar.php" class="nav-link active"><i class="fas fa-paper-plane"></i> Surat Keluar</a></li>
        </ul>
    ...
    <div class="main-content">
        ...
        <div class="header-section">
            <div>
                <h1>Surat Keluar</h1>
                <p style="color: var(--text-muted)">Manage outgoing mail records.</p>
            </div>
            ...
            <form action="" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="tujuan_surat" required value="<?php echo htmlspecialchars($edit_data ? $edit_data['tujuan_surat'] : ''); ?>">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" name="tgl_kirim" required value="<?php echo htmlspecialchars($edit_data ? $edit_data['tgl_kirim'] : ''); ?>">
                    </div>
                    <div class="form-group">
                ...
                <?php if($edit_data): ?>
                    <a href="surat_keluar.php" class="btn btn-danger" style="margin-left: 10px;">Batal</a>
                <?php endif; ?>
            </form>
        </div>

        <div class="card">
            <div class="card-title">Daftar Surat Keluar</div>
